...
const int rs = 12, en = 17, d4 = 18, d5 = 19, d6 = 20, d7 = 24;
 LiquidCrystal lcd(rs, en, d4, d5,d6, d7);

int T = 1000;              // slot milliseconds to read a value from the sensor
int sensorPin = 2; 
int REDLed = 21;
int IRLed = 22;
int ControlLed = 24;
...
void loop (){
  ...
  if (air_quality <=450)
      {
        Serial.print("Fresh_Air, CO Gas Safe!: ");
        Serial.print("Air Quality CO: ");
        Serial.print(air_quality/1000);      
        Serial.println(" PPM");
